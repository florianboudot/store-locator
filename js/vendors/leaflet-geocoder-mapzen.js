...
;(function (factory) { // eslint-disable-line no-extra-semi
    ...
    L.Control.Geocoder = L.Control.extend({
        ...
        options: {
            ...
            querySize: 10, // results size (added by flobou)
            resultsSize: 10, // results size (added by flobou)
        ...
        getresultsSize: function (params) { // (added by flobou)
            var size = this.options.resultsSize; //

            if (!size) {
                return params;
            }

            params['resultsSize'] = size;
            return params;
        },
        ...
        callPelias: function (endpoint, params, type) {
            ...
            params = this.getresultsSize(params); // (added by flobou)
            ...
            AJAX.request(endpoint, params, function (err, results) {
                ...
                if (results && results.features) {
                    ...
                    // Show results
                    if (type === 'autocomplete' || type === 'search') {
                        this.showResults(results.features, params.text, params.resultsSize);
                    }
